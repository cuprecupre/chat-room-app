...
4.  **Complete Configuration**: Infrastructure is not just "servers"; it includes Environment Variables, Auth providers, Domains, and Database connections. A task is not done until the app is _usable_.
