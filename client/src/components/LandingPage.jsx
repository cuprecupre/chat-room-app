...
export function LandingPage({ onLogin, onGoToEmailAuth, isLoading, onOpenInstructions, onOpenFeedback, invitedGameId, hostName }) {
                    ...
                    <div className="w-full max-w-sm mx-auto text-center space-y-6 px-6">
                        ...
                        <div>
                            ...
                            <p className="text-neutral-300 text-lg leading-relaxed">
                                Has recibido un enlace para unirte a la partida de <span className="font-mono font-bold text-orange-400 bg-orange-400/10 px-2 py-0.5 rounded">{hostName || invitedGameId}</span>.
                            ...
                            >
                                <span className="mr-3 inline-flex items-center justify-center align-middle">
                                    {isLoading ? (
                                        ...
                                        <svg width="20" height="20" viewBox="0 0 16 16" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
                                            <g clipPath="url(#clip0_buttons_invited)">
                                            ...
                                            <defs>
                                                <clipPath id="clip0_buttons_invited">
                        ...
                        <div className="w-full md:w-1/2 space-y-8 relative z-10">
                            ...
                            <ul className="space-y-3 pt-2">
                                <li className="flex items-center gap-3 text-neutral-300">
                                    <span className="text-green-500">✓</span> Partidas rápidas de 5-10 minutos
                                </li>
                                <li className="flex items-center gap-3 text-neutral-300">
                                    <span className="text-green-500">✓</span> Sin directores de juego
                                </li>
                                <li className="flex items-center gap-3 text-neutral-300">
                                    <span className="text-green-500">✓</span> Totalmente gratis y sin anuncios molestos
                                </li>
                            </ul>
                        </div>
                ...
                <div className="max-w-3xl mx-auto space-y-10 relative z-10">
                    ...
                    <div className="flex justify-center pt-4">
                        ...
                        >
                                ...
                                {isLoading ? (
                                    ...
                                    <svg width="20" height="20" viewBox="0 0 16 16" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_643_9687_footer)">
                                            <path d="M8.00018 3.16667C9.18018 3.16667 10.2368 3.57333 11.0702 4.36667L13.3535 2.08333C11.9668 0.793333 10.1568 0 8.00018 0C4.87352 0 2.17018 1.79333 0.853516 4.40667L3.51352 6.47C4.14352 4.57333 5.91352 3.16667 8.00018 3.16667Z" fill="white" />
                                            <path d="M15.66 8.18335C15.66 7.66002 15.61 7.15335 15.5333 6.66669H8V9.67335H12.3133C12.12 10.66 11.56 11.5 10.72 12.0667L13.2967 14.0667C14.8 12.6734 15.66 10.6134 15.66 8.18335Z" fill="white" />
                                            <path d="M3.51 9.53001C3.35 9.04668 3.25667 8.53334 3.25667 8.00001C3.25667 7.46668 3.34667 6.95334 3.51 6.47001L0.85 4.40668C0.306667 5.48668 0 6.70668 0 8.00001C0 9.29334 0.306667 10.5133 0.853333 11.5933L3.51 9.53001Z" fill="white" />
                                            <path d="M8.0001 16C10.1601 16 11.9768 15.29 13.2968 14.0633L10.7201 12.0633C10.0034 12.5467 9.0801 12.83 8.0001 12.83C5.91343 12.83 4.14343 11.4233 3.5101 9.52667L0.850098 11.59C2.1701 14.2067 4.87343 16 8.0001 16Z" fill="white" />
                                        </g>
                                        <defs>
                            ...
                            <span className="align-middle font-semibold">Empezar Partida Gratis</span>
                        </Button>
                    </div>
                </div>
            </section>
