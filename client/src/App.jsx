...
export default function App() {
    ...
    useEffect(() => {
        window.scrollTo(0, 0);
    }, [user?.uid, gameState?.gameId, showEmailAuthScreen]);
                    ...
                    <div className="w-full max-w-sm mx-auto text-center space-y-6">
                        ...
                        <div>
                            ...
                            <p className="text-neutral-400">
                                No se puede conectar al servidor. Esto puede deberse a problemas de
                                red o el servidor está inactivo.
                            </p>
                        </div>
                        <div className="space-y-3 px-6">
                            ...
                            <Button onClick={forceExit} variant="outline">
                                Forzar salida
                            </Button>
                        </div>
                    </div>
                ...
                {showHeader && (
                    <header className="flex justify-between items-center mb-6 pb-6 border-b border-white/10">
                        ...
                        <div className="flex items-center gap-3 sm:gap-4">
                            <span className="text-sm sm:text-base font-medium hidden sm:inline flex items-center">
                                {user.displayName}
                            </span>
