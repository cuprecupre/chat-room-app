    ...
    return (
        <div className="min-h-screen bg-neutral-950 text-neutral-50 flex flex-col font-sans selection:bg-orange-500/30 overflow-x-hidden allow-select">
            ...
            <a
                ...
                className="w-full h-12 md:h-8 bg-[#5865F2] flex items-center justify-center px-4 hover:bg-[#4752C4] transition-colors"
            >
            ...
            {/* Navbar Fixed */}
            <nav className="sticky top-0 z-40 bg-neutral-950/80 backdrop-blur-md border-b border-white/5 py-4 px-6 md:px-12 flex justify-between items-center transition-all duration-300">
                <div
                    className="flex items-center gap-2 cursor-pointer"
                    onClick={() => window.scrollTo(0, 0)}
                >
                    <span className="text-xl md:text-2xl font-normal font-serif tracking-wide text-neutral-100">
                        {tc('login.appTitle')}
                    </span>
                </div>
                ...
                <div className="relative z-10 max-w-4xl mx-auto space-y-8">
                    ...
                    <div className="flex flex-col gap-4 justify-center items-center animate-fadeIn animate-delay-600 w-full max-w-md mx-auto">
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group flex items-center justify-center gap-3 px-8 h-14 rounded-full bg-[#5865F2]/15 hover:bg-[#5865F2]/25 border border-[#5865F2]/30 hover:border-[#5865F2]/50 transition-all duration-300 w-full"
                        >
                            <svg
