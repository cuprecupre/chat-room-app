        ...
        <div className="w-full space-y-8 pt-8">
            ...
            <div className="max-w-sm mx-auto space-y-6">
                ...
                <a
                    ...
                    className="group bg-[#5865F2]/15 hover:bg-[#5865F2]/25 border border-[#5865F2]/30 hover:border-[#5865F2]/50 rounded-lg p-4 flex gap-3 items-start text-left transition-all duration-300 cursor-pointer"
                >
                    <svg
                        className="w-5 h-5 text-[#5865F2] shrink-0 mt-0.5 group-hover:scale-110 transition-transform duration-300"
                        fill="currentColor"
                        viewBox="0 0 24 24"
