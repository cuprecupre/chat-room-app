...
export function SEO({ title, description, path = "" }) {
    ...
    return (
        <Helmet>
            ...
            <title>{title ? `${title} | El Impostor` : "El Impostor - Juego de Deducción Social"}</title>
            <meta name="description" content={description} />

            {/* Open Graph */}
            <meta property="og:title" content={title || "El Impostor"} />
            ...
            <meta name="twitter:title" content={title || "El Impostor"} />
