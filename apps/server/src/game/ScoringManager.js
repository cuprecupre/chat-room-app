function calculateRoundScores(game, friendsWon) {
    ...
    if (friendsWon) {
        ...
        game.playerScores[game.impostorId] =
            (game.playerScores[game.impostorId] || 0) + finalTurnPoints;
        game.lastRoundScores[game.impostorId] =
            (game.lastRoundScores[game.impostorId] || 0) + finalTurnPoints;
        console.log(
            `[Game ${game.gameId}] Impostor gana la ronda en vuelta ${game.currentTurn}: +${finalTurnPoints} puntos`
        );
